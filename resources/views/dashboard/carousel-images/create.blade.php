@extends('layouts.app', ['title' => 'Create Hero Image'])
@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Add Hero Image</h1>
        </div>
        <nav style="--bs-breadcrumb-divider:'>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active font-weight-bolder text-primary">Add Hero Image</li>
            </ol>
        </nav>
        <div class="card">
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h5 mb-0 text-gray-800 font-weight-bolder">Add Hero Image Form</h1>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-3" id="cover-preview" style="display: none">
                                <img id="cover-image" src="" alt="Cover Preview" class="img-fluid img-thumbnail"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" value="{{ old('title') }}" class="form-control"
                                id="title" placeholder="Image Title" required>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="order_position" class="col-sm-2 col-form-label">Position</label>
                        <div class="col-sm-10">
                            <input type="number" name="order_position" value="{{ old('order_position') }}"
                                class="form-control" id="order_position" placeholder="3" min="1" required>
                        </div>
                    </div>
